...
# The subscription service only listens on 127.0.0.1:8081; nginx exposes it on :8082
# to avoid clashing with the SPBTE site that owns :80.
...
Done. Open the admin panel at:
  http://${HY_SERVER_HOST}:8082/admin
